...
public class EmployeeTest
{
	...
	public Employee[] getEmployee()
	{
		...
		employees[0] = new Employee(new StringBuilder("张三"), new StringBuilder("经理"), LocalDate.of(1999, 2, 13),
		                            10000.12, 30);
		employees[1] = new Employee(new StringBuilder("李四"), new StringBuilder("程序员"), LocalDate.of(1986, 7, 12),
		                            12687.54, 25);
		employees[2] = new Employee(new StringBuilder("王五"), new StringBuilder("程序员"), LocalDate.of(1992, 3, 23),
		                            9876.32, 28);
		employees[3] = new Employee(new StringBuilder("赵六"), new StringBuilder("程序员"), LocalDate.of(1995, 4, 14),
		                            8765.43, 27);
		employees[4] = new Employee(new StringBuilder("孙七"), new StringBuilder("程序员"), LocalDate.of(1998, 5, 25),
		                            7654.32, 26);
		...
		employees[5].setHireDay(LocalDate.of(1997, 6, 16));
		...
		employees[6].setHireDay(LocalDate.of(1996, 7, 17));
		...
		employees[7].setHireDay(LocalDate.of(1995, 8, 18));
		...
		employees[8].setHireDay(LocalDate.of(1994, 9, 19));
		...
		employees[9].setHireDay(LocalDate.of(1993, 10, 20));
